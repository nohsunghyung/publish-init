  ...
  function bn(e) {
    ...
    for (var t = 1, n = arguments.length; t < n; ++t) {
      ...
      if (o)
        for (var r in o)
          o.hasOwnProperty(r) &&
            ('[object Object]' !== Object.prototype.toString.call(o[r]) ? (e[r] = o[r]) : (e[r] = bn(e[r], o[r])));
    }
    return e;
  }
  function yn(e, t) {
    ...
    function (e, E) {
            ...
            E.css3 &&
              (E.css3 = (function () {
                ...
                for (var o in ((t.style.display = 'block'), Nt.body.insertBefore(t, null), n))
                  void 0 !== t.style[o] &&
                    ((t.style[o] = 'translate3d(1px,1px,1px)'), (e = Rt.getComputedStyle(t).getPropertyValue(n[o])));
                ...
                E.navigation &&
                  (function () {
                    ...
                    for (var o = '', r = 0; r < wn(_t).length; r++) {
                      ...
                      void 0 !== l &&
                        '' !== l &&
                        (o += '<div class="' + tn + ' fp-' + E.navigationPosition + '">' + l + '</div>'),
                        (o += '</li>');
                    }
                    (wn('ul', n)[0].innerHTML = o),
                      xn(wn(en), { 'margin-top': '-' + wn(en)[0].offsetHeight / 2 + 'px' }),
        ...
        'touchend' === t &&
          ...
          ('mouseenter' !== t || V) &&
            (E.normalScrollElements.split(',').forEach(function (e) {
              if (!o) {
                var t = _n(i, e),
                  n = Dn(i, e);
                (t || n) &&
                  (h.shared.isNormalScrollElement || (re(!1), r && E.scrollOverflowHandler.setIscroll(i, !1)),
            ...
            !o &&
              ...
              (re(!0), r && E.scrollOverflowHandler.setIscroll(i, !0), (h.shared.isNormalScrollElement = !1)));
      }
      function Se() {
        var e = En(),
          t = Ln();
          ...
          1 < n &&
            (E.controlArrows &&
              ...
              '#fff' !== E.controlArrowColor &&
                (xn(wn(mn, l), { 'border-color': 'transparent transparent transparent ' + E.controlArrowColor }),
                xn(wn(gn, l), { 'border-color': 'transparent ' + E.controlArrowColor + ' transparent transparent' })),
            ...
            E.slidesNavigation &&
              (function (e, t) {
                ...
                for (var o = 0; o < t; o++)
                  Nn(
                    qn('<li><a href="#"><span class="fp-sr-only">' + be(o, 'Slide') + '</span><span></span></a></li>'),
                    wn('ul', n)[0]
                  );
      ...
      function Be(e, t, n) {
        if (null != e) {
          ...
          if (!((d.activeSection == e && !g) || (E.scrollBar && Yn() === d.dtop && !yn(e, Gt)))) {
            if (
              (null != d.activeSlide && ((u = d.activeSlide.getAttribute('data-anchor')), (f = Cn(d.activeSlide))),
              !d.localIsResizing)
            ) {
              var v = d.yMovement;
              if (
                (void 0 !== n && (v = n ? 'up' : 'down'), (d.direction = v), Xn(E.onLeave) && !1 === Re('onLeave', d))
              )
                return;
            }
            E.autoScrolling &&
      ...
      function Pe(e) {
        ...
        null != (t = e).wrapAroundElements &&
          (t.isMovementUp ? Wn(wn(_t)[0], t.wrapAroundElements) : Vn(wn(_t)[wn(_t).length - 1], t.wrapAroundElements),
          xt(wn($t)[0].offsetTop),
          Ie()),
      ...
      function gt(e, t) {
        ...
        if (null != n) {
          var o,
            ...
            i,
            l =
              (null == (i = wn(on + '[data-anchor="' + (o = t) + '"]', (r = n))[0]) &&
      ...
      function St(e, t, n, o) {
        ...
        E.anchors.length &&
          !E.lockAnchors &&
          (e ? (null != n && (r = n), null == t && (t = e), wt(r + '/' + (i = t))) : (null != e && (i = t), wt(n))),
          yt();
      }
      function wt(e) {
            ...
            : (E.continuousVertical &&
              ...
              E.anchors.forEach(function (t) {
                ...
                if (n.length || e.length) {
                  ...
                  (n.length || e.length) &&
                    Sn('error', '"' + t + '" is is being used by another element `' + o + '` property');
                }
              }));
      }
      function Mt(t, n, o, r) {
